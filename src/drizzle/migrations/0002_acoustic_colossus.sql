...
CREATE TABLE IF NOT EXISTS "category" (
	"category" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "postcategory" ADD CONSTRAINT "postcategory_categoryId_category_category_fk" FOREIGN KEY ("categoryId") REFERENCES "public"."category"("category") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
